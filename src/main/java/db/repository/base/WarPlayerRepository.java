...
public interface WarPlayerRepository extends Repository<WarPlayer, WarPlayerId> {
    /**
     ...
     */
    int countOfPlayer(UUID playerUUID);
     ...
     * @return Count. -1 if something went wrong.
     */
    int countOfPlayer(UUID playerUUID, String guildName);
     ...
     */
    int countSuccessWars(UUID playerUUID);
     ...
     * @return Count of success wars. -1 if something went wrong.
     */
    int countSuccessWars(UUID playerUUID, String guildName);
     ...
     */
    int countSurvivedWars(UUID playerUUID);
     ...
     * @return Count of survived wars. -1 if something went wrong.
     */
    int countSurvivedWars(UUID playerUUID, String guildName);
     ...
     */
    @Nullable
    List<WarPlayer> getLogsOfPlayer(UUID playerUUID, int limit, int offset);
     ...
     */
    @Nullable
    List<WarPlayer> getLogsOfPlayer(UUID playerUUID, String guildName, int limit, int offset);
     ...
     */
    @Nullable
    WarPlayer getUUIDNullPlayer(int offset);
     ...
     */
    boolean updatePlayerUUIDBetween(String playerName, UUID uuid, Date start, Date end);
}
