...
public class GainedXpRank extends GenericCommand {
    ...
    public void process(@NotNull MessageReceivedEvent event, @NotNull String[] args) {
        ...
        Function<Integer, Message> pageSupplier = pageSupplier(xpLeaderboard, customDateFormat, customTimeZone);
    ...
    private Function<Integer, Message> pageSupplier(@NotNull List<GuildXpLeaderboard> leaderboard,
        ...
        return page -> {
            ...
            Date oldest = leaderboard.get(0).getFrom();
            Date newest = leaderboard.get(0).getTo();
